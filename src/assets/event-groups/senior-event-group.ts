  ...
  new KeyedStaticCollection<EventGroup>({
    ...
    '2022': new EventGroup(
      ...
      [
        new RankingEvent('_s_nationals_', new Rating(1500)),
        new RankingEvent('_s_national_indoor_', new Rating(600)),
        new RankingEvent('_s_prov_tier_1_2022_', new Rating(450)),
        new RankingEvent('_s_prov_tier_2_2022_', new Rating(300)),
        new RankingEvent('_s_prov_tier_3_2022_', new Rating(150)),
      ]
    )
  });
